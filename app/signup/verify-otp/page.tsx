      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 sm:p-8">
          ...
          >
            ...
            {/* Error */}
            {error && (
              <div className="mt-5 rounded-xl border border-red-100 bg-red-50 px-4 py-3 text-center text-sm font-medium text-red-600">
                {error}
              </div>
            )}
          ...
          <div className="mt-7 border-t border-slate-100 pt-6 text-center">
            ...
            <Link
              href="/signup"
              className="mt-3 inline-block text-xs font-semibold text-slate-500 transition hover:text-blue-600"
            >
