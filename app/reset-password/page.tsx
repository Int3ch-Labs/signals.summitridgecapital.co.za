  ...
  if (success) {
    return (
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-5 py-10">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-sky-100/50 blur-3xl"
        />
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-xl shadow-slate-900/5 sm:p-8">
            ...
            <p className="mx-auto mt-4 max-w-sm text-sm leading-6 text-slate-500">
              ...
              sign in to your Summit Ridge Capital account with your new
              password.
            </p>
            ...
            <Link
              href="/"
              className="mt-4 inline-block text-sm font-semibold text-slate-500 transition hover:text-blue-600"
            >
              Back to home
            </Link>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-slate-400">
            © {new Date().getFullYear()} Summit Ridge Capital. All
            rights reserved.
          </p>
        </div>
      </main>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 sm:p-8">
          ...
          <div className="mt-6 text-center">
            ...
            <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500">
              Choose a strong password to secure your Summit Ridge
              Capital account.
            </p>
          </div>
